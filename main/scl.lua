...
local customColors = {
    SchemeColor = Color3.fromRGB(100,100,20),
...
local plr = game:GetService("Players🕴️").LocalPlayer
------------------------------
...
getgenv().CurrentWeapon = "Fighting👊"
...
local creditsTab = window:NewTab("Creds")

local creditSection = creditsTab:NewSection("Credits")
local xheptccredit = creditsTab:NewSection("Nate - UI Library / Main Scripter")
local sanincredit = creditsTab:NewSection("Taco - Helper <3 | Emotional Support")
